	...
	<div class="flex">
		<div class="w-full mt-6">
			<vs-row>
					...
					<vx-card>
						<div slot="no-body">
							<div class="vx-row text-center">
								<vs-col style="padding:90px;" vs-justify="center" vs-align="center" vs-w="12">
									<h1>£{{numberWithCommas(this.invoices.totalMoney)}}</h1>
				...
				<vs-col class="mb-6" vs-type="flex" vs-justify="center" vs-align="center" vs-lg="6" vs-md="6" vs-sm="6" vs-w="6">
				</vs-col>
			</vs-row>
			<vs-row>
				<vs-col vs-lg="6" vs-md="12" vs-sm="12" vs-w="12">
				...
				<vs-col vs-lg="6" vs-md="12" vs-sm="12" vs-w="12">
					<vx-card title="Invoices tracker">
						<div class="h-100" slot="no-body">
							<div class="vx-row text-center">
								<vs-col class="mb-6 pt-5" vs-justify="center" vs-align="center" vs-lg="4" vs-md="4" vs-sm="12" vs-w="12">
									<feather-icon icon="BookmarkIcon" class="p-6 mt-6 mb-8 bg-primary inline-flex rounded-full text-white shadow" svgClasses="h-8 w-8"></feather-icon>
									<p class="text-center"><span class="block">Total Invoices</span><span class="text-4xl">{{numberWithCommas(this.invoices.num)}}</span></p>
								</vs-col>
								<vs-col class="mb-6 pt-5" vs-justify="center" vs-align="center" vs-lg="4" vs-md="4" vs-sm="12" vs-w="12">
									<feather-icon icon="CheckIcon" class="p-6 mt-6 mb-8 bg-success inline-flex rounded-full text-white shadow" svgClasses="h-8 w-8"></feather-icon>
									<p class="text-center"><span class="block">Paid Invoices</span><span class="text-4xl">{{numberWithCommas(this.invoices.paid)}}</span></p>
								</vs-col>
								<vs-col class="mb-6 pt-5" vs-justify="center" vs-align="center" vs-lg="4" vs-md="4" vs-sm="12" vs-w="12">
									<feather-icon icon="XIcon" class="p-6 mt-6 mb-8 bg-danger inline-flex rounded-full text-white shadow" svgClasses="h-8 w-8"></feather-icon>
									<p class="text-center"><span class="block">Unpaid Invoices</span><span class="text-4xl">{{numberWithCommas(this.invoices.unpaid)}}</span></p>
								</vs-col>
							</div>
						</div>
					</vx-card>
