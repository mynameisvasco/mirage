<template>
	<div class="flex mb-4">
		<vs-popup class="holamundo" title="Add a new employee" :active.sync="newPopupActive">
            ...
            <div class="vx-row mb-6">
				<div class="vx-col w-full">
					...
					<v-select placeholder="Select a role" v-model="newClient.company_rank" :options="[{label: 'Administrator', value: 3}, {label: 'Financial', value: 2}, {label: 'Support', value: 1}]"></v-select>
				</div>
			</div>
			<div class="vx-row mb-6">
				<div class="vx-col w-full">
		...
		<vs-popup class="holamundo" title="Edit employee" :active.sync="editPopupActive">
			<div class="vx-row mb-6">
				<div class="vx-col w-full">
		...
		<div class="w-full mt-6">
			<vs-button icon-pack="feather" class="mb-4" @click="newPopupActive = true" icon="icon-plus">New Employee</vs-button>
