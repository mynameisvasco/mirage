...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    sosPinGenerator: function sosPinGenerator() {
      ...
      _c(
        "vs-popup",
        {
          ...
          attrs: {
            ...
            active: _vm.urgentPopUpActive
          },
          on: {
            "update:active": function($event) {
              _vm.urgentPopUpActive = $event
            }
          }
        },
        [
          _c(
            ...
            [
              _c("vs-col", { staticClass: "mb-4", attrs: { "vs-w": "12" } }, [
                _c("p", [
                  _vm._v(
                    "You are going to be redirected to our SOS software, after download it you should open it and after that create a ticket and send the code that you received, so that our support\n\t\t\t\tteam can help you."
                  )
                ])
              ]),
              _vm._v(" "),
