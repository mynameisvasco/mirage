  ...
  methods: {
    ...
    getClient: function getClient(id) {
      ...
      this.$http.get('/api/users/' + id, {
        ...
        _this3.editClient = response.data;
      })["catch"](function (error) {
        console.log(error);
      });
    },
    ...
    updateClient: function updateClient() {
      ...
      this.$http.post('/api/users/' + this.editClient.id, formData, {
        ...
        for (var i = 0; i < _this5.clients.length; i++) {
          if (_this5.clients[i].id == response.data.id) {
            _this5.$set(_this5.clients, i, response.data);
          }
        }
    ...
    deleteClient: function deleteClient(id) {
      ...
      this.$http["delete"]('/api/users/' + id, {
        ...
        for (var i = 0; i < _this6.clients.length; i++) {
          if (_this6.clients[i].id == id) {
            _this6.$delete(_this6.clients, i);
          }
        }
          ...
          _c("div", { staticClass: "vx-row mb-6" }, [
            _c(
              ...
              [
                _c(
                  "label",
                  { staticClass: "ml-1", staticStyle: { "font-size": "12px" } },
                  [_vm._v("Company")]
                ),
                _c("br"),
                _vm._v(" "),
                _c("v-select", {
                  ...
                  model: {
                    value: _vm.newClient.company_id,
                    callback: function($$v) {
                      _vm.$set(_vm.newClient, "company_id", $$v)
                    },
                    expression: "newClient.company_id"
                  }
                })
              ],
              1
